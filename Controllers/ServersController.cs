...
namespace CSCAP.Controllers
{
    public class ServersController : Controller
    {
        ...
        public ServersController(CSCAPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Server != null ? 
                          ...
                          Problem("Entity set 'CSCAPContext.Server'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ServerId,Name,Ip")] Server server)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServerId,Name,Ip")] Server server)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CSCAPContext.Server'  is null.");
            }
            var server = await _context.Server.FindAsync(id);
            if (server != null)
            {
